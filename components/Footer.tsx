    ...
    <footer className="bg-black text-white py-16 lg:py-20">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          {/* Brand */}
          <div>
            <div className="text-2xl font-bold mb-4">DND</div>
            <p className="text-gray-400 text-sm mb-4">
              Drishti Nimawat Designs
            </p>
            <p className="text-gray-400 text-sm">
              Crafting extraordinary spaces that embody your unique vision and elevate the art of living.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/our-process" className="text-gray-400 hover:text-white text-sm transition-colors">
                  Our Process
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>Email: drishtinimawatdesigns@gmail.com</li>
              <li>Phone: +91 70736 20688</li>
            </ul>
            <div className="mt-6 flex space-x-4">
              <a href="https://www.facebook.com/profile.php?id=61584377022217" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
              <a href="https://www.instagram.com/drishtinimawatdesigns?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="max-w-md mx-auto text-center">
            ...
            <form className="flex gap-2" onSubmit={(e) => {
              ...
              <button
                type="submit"
                className="bg-white text-black px-6 py-3 text-sm font-medium uppercase tracking-wider hover:bg-gray-100 transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} DND (Drishti Nimawat Designs). All rights reserved.
          </p>
        </div>
      </div>
    </footer>
