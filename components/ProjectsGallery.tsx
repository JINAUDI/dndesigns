...
function ProjectCard({ project, index, inView }: { project: Project, index: number, inView: boolean }) {
  ...
  // Check if this is a dynamic project (from folder) - they don't have detail pages
  const isDynamic = project.slug.startsWith('residential-') || project.slug.startsWith('commercial-')
  ...
  return (
    ...
    >
      {isDynamic ? content : <Link href={`/projects/${project.slug}`}>{content}</Link>}
    </motion.div>
  )
}
