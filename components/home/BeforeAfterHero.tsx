...
const slideData = {
  ...
  subtext: 'Shaped into timeless spaces.',
          ...
          <div className="ba-hero__before">
            ...
            <div className={`ba-hero__content ba-hero__content--before ${isLoaded ? 'is-visible' : ''}`}>
              <h1 className="ba-hero__headline ba-hero__headline--dark">
                {slideData.headlinePre && <span className="ba-hero__headline-pre">{slideData.headlinePre}</span>}
                <span className="ba-hero__headline-accent">{slideData.headlineAccent}</span>
              </h1>
